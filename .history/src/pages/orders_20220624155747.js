...
export async function getServerSideProps(context) {
  ...
  console.log(db.collection('users').doc('nupur532002@gmail.com').doc('/project/undefined/firestore/data/users/nupur532002@gmail.com/orders/cs_test_a1JQzXlIqabFbHgtdwQkEYq5g4zDRQtUgwQUNewSOi4WDjlTYac3MUiwYC') );
  //firebase database
