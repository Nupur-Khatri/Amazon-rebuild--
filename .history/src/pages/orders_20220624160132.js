...
export async function getServerSideProps(context) {
  ...
  console.log(db.collection('users').doc('nupur532002@gmail.com').collection('orders').doc('cs_test_a1JQzXlIqabFbHgtdwQkEYq5g4zDRQtUgwQUNewSOi4WDjlTYac3MUiwYC').data());
  //firebase database
